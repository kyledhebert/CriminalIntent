...
public class DatePickerFragment extends DialogFragment {
    ...
    public static final String EXTRA_DATE = "com.kylehebert.criminalintent.date";
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        //this date will be used to configure the calendar below
    ...
    /*
    create an intent, add the date to the intent as an extra,
    then call CrimeFragment's onActivityResult to pass the date back to target
     */
